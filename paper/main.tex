...
\begin{align*}
    ...
    \sum_{\alpha} q_\alpha \int &f_\alpha d^3(f_v) = 0 \text{ (Quasineutrality)}\\
\frac{d}{dt} \int &f_\alpha \log f_\alpha d^3r d^3(f_v) = 0 \text{ (Liouville)}\\
\nabla \cdot f_E &= \frac{\sum_{\alpha} \rho_\alpha}{\epsilon_0} \\
\nabla \cdot f_B &= 0 \\
\nabla \times f_E &= - \frac{\partial f_B}{\partial t} \\
\nabla \times f_B &= \mu_0 \left(J + \epsilon_0 \frac{\partial f_E}{\partial t}\right) \text{ (Maxwell)} \\
\end{align*}
...
\begin{align*}
    r &\in \left[10R_E, 240R_E\right] \\
    v_x &\in \left[300, 1000\right]\frac{km}{s} \\
    t &\in \left[0, 7200]s \\
\end{align*}
